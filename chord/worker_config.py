...
MAX_RECOVERY_ATTEMPTS           = 3   # give up after this many total assignment attempts
RECOVERY_CHECK_INTERVAL_SECONDS = 5   # how often the recovery loop scans for failures
